...
extension SlideRightThenPopTransitionAnimator : UIViewControllerAnimatedTransitioning
{
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning)
    {
        ...
        UIView.animateWithDuration(duration/2.0, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.4, options: [], animations: { () -> Void in
        ...
        UIView.animateWithDuration(duration/2.0, delay: duration/2.0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.4, options: [], animations: { () -> Void in
